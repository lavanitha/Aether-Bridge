...
// CORS configuration - allow frontend on common dev ports
app.use(cors({
  origin: process.env.FRONTEND_URL
    ? process.env.FRONTEND_URL.split(',').map((o) => o.trim())
    : ['http://localhost:3000', 'http://localhost:5173', 'http://localhost:8080', 'http://localhost:8085', 'http://localhost:8086', 'http://127.0.0.1:8086'],
  credentials: true,
