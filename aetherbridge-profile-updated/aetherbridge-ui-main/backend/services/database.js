...
async function initializeInMemoryStorage() {
  ...
  const sampleCourses = [
    { id: '1', title: 'Introduction to Computer Science', institution: 'Harvard University', category: 'Computer Science', credits: 3, description: 'Fundamental concepts of computer science and programming', duration: '12 weeks', level: 'beginner', isFeatured: true, equivalencyMetadata: {}, createdAt: new Date(), updatedAt: new Date() },
    { id: '2', title: 'Machine Learning Fundamentals', institution: 'Stanford University', category: 'Artificial Intelligence', credits: 4, description: 'Introduction to machine learning algorithms and applications', duration: '16 weeks', level: 'intermediate', isFeatured: true, equivalencyMetadata: {}, createdAt: new Date(), updatedAt: new Date() },
    { id: '3', title: 'Blockchain Technology', institution: 'MIT', category: 'Blockchain', credits: 3, description: 'Understanding blockchain technology and its applications', duration: '10 weeks', level: 'intermediate', isFeatured: true, equivalencyMetadata: {}, createdAt: new Date(), updatedAt: new Date() },
    { id: '4', title: 'Data Science Essentials', institution: 'UC Berkeley', category: 'Data Science', credits: 4, description: 'Comprehensive introduction to data science and analytics', duration: '14 weeks', level: 'intermediate', isFeatured: false, equivalencyMetadata: {}, createdAt: new Date(), updatedAt: new Date() },
    { id: '5', title: 'Cybersecurity Fundamentals', institution: 'Carnegie Mellon University', category: 'Cybersecurity', credits: 3, description: 'Essential cybersecurity concepts and practices', duration: '12 weeks', level: 'beginner', isFeatured: false, equivalencyMetadata: {}, createdAt: new Date(), updatedAt: new Date() }
  ];
